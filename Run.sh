...
echo This Script Is Created By MR PRO >update.mrpro
...
echo -e "\e[4;34mThis Tool Is Created By MR PRO \e[0m" #underline+blue
echo " "
...
toilet -f pagga -F border MR PRO | lolcat
echo " "
exit 0
else
